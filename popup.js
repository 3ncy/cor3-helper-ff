...
checkUpdateBtn.addEventListener('click', async () => {
    ...
    try {
        ...
        const versionsResp = await fetch('https://raw.githubusercontent.com/3ncy/cor3-helper-ff/refs/heads/main/versions.json', { cache: 'no-store' });
        ...
        try {
            const manifestResp = await fetch('https://raw.githubusercontent.com/3ncy/cor3-helper-ff/refs/heads/main/manifest.json', { cache: 'no-store' });
            if (manifestResp.ok) {
        ...
        if (messages.length > 0) {
            ...
            if (extBehind) {
                html += `<br><a href="https://github.com/3ncy/cor3-helper-ff/releases" target="_blank" style="color:var(--accent-cyan);">Download from GitHub</a><br><span style="font-size:9px;color:var(--text-muted);">Download the latest .xpi, then install it via about:addons</span>`;
            }
